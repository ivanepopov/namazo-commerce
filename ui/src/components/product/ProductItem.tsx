...
import imageMissing from "@/util/ifbit - transparent.png"
...
export default function Item(props: Props) {
  ...
  return (
    <a key={props.product_data.title} href={`/store/${props.product_data.category}/${props.product_data.id}`}
      ...
      <Image className="w-24 h-24 object-contain" priority width={96} height={96} alt="item" src={ url ? props.product_data.image : imageMissing } />
