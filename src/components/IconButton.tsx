...
export default function IconButton(props: Props) {
  ...
  switch (props.icon) {
    ...
    case "moon":
      svg =
      <svg className="text-indigo-600 dark:text-orange-400" width="24" height="24" viewBox="0 0 512 512">
    ...
    case "search":
      svg =
      <svg className="text-indigo-600 dark:text-orange-400" width="24" height="24" viewBox="0 0 32 32"> 
  ...
  return (
    <div
        className="border border-solid rounded-full border-transparent transition-colors
                    flex items-center justify-center
                    hover:bg-indigo-600/15 dark:hover:bg-orange-400/15
